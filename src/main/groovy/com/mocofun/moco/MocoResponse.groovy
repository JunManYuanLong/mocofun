...
class MocoResponse extends MocoRequest {
    ...
    static ResponseHandler random(String content, String... contents) {
        RandomHandler.newSeq(FluentIterable.from(com.github.dreamhead.moco.util.Iterables.asIterable(content, contents)).transform(com.github.dreamhead.moco.internal.ApiUtils.textToResource()))
    }
    ...
    static ResponseHandler random(JSONObject json, JSONObject... jsons) {
        RandomHandler.newSeq(FluentIterable.from(com.github.dreamhead.moco.util.Iterables.asIterable(json.toString(), jsons.toList().stream().map {x -> x.toString()}.toArray() as String[])).transform(com.github.dreamhead.moco.internal.ApiUtils.textToResource()))
    }
    ...
    static ResponseHandler random(ResponseHandler handler, ResponseHandler... handlers) {
        RandomHandler.newSeq(com.github.dreamhead.moco.util.Iterables.asIterable(handler, handlers))
    }
    ...
    static ResponseHandler cycle(String content, String... contents) {
        CycleHandler.newSeq(FluentIterable.from(com.github.dreamhead.moco.util.Iterables.asIterable(content, contents)).transform(com.github.dreamhead.moco.internal.ApiUtils.textToResource()))
    }
    ...
    static ResponseHandler cycle(JSONObject json, JSONObject... jsons) {
        CycleHandler.newSeq(FluentIterable.from(com.github.dreamhead.moco.util.Iterables.asIterable(json.toString(), jsons.toList().stream().map {x -> x.toString()}.toArray() as String[])).transform(com.github.dreamhead.moco.internal.ApiUtils.textToResource()))
    }
    ...
    static ResponseHandler cycle(ResponseHandler handler, ResponseHandler... handlers) {
        CycleHandler.newSeq(com.github.dreamhead.moco.util.Iterables.asIterable(handler, handlers))
    }
